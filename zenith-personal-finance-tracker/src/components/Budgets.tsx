...
}> = ({ onAdd, categories, existingBudgetCategoryIds, onOpenAISuggestions }) => {
...
const Budgets: React.FC<BudgetsProps> = ({ finance, apiKey }) => {
  const { budgets, categories, addBudget, getSpentAmountForCategory, getCategoryById } = finance;
    ...
    <>
      <div className="space-y-8">
        ...
        <AddBudgetForm 
          ...
          onOpenAISuggestions={() => setIsAIBudgetModalOpen(true)}
        />

        <div>
          <h2 className="text-2xl font-bold text-white mb-4">Your Budgets ({budgets.length})</h2>

...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, openExportModal }) => {
  const navItems: { id: View; label: string; icon: JSX.Element }[] = [
    ...
    { id: 'debt', label: 'Debt Planner', icon: <DebtPlannerIcon /> },
      ...
      <div>
        ...
        <nav className="space-y-2">
         ...
         <div className="mt-6 border-t border-gray-700 pt-6 space-y-2">
            ...
            <NavItem label="Connect Accounts" icon={<LinkIcon />} isActive={activeView === 'banksync'} onClick={() => setActiveView('banksync')} />
            <NavItem label="Export Data" icon={<ExportIcon />} onClick={openExportModal} />
        </div>
      </div>

...
const ChatView: React.FC<{ finance: UseFinanceReturn; apiKey: string | null }> = ({ finance, apiKey }) => {
    ...
    }, [finance.transactions, finance.budgets, finance.summary, finance.categories]);
    ...
    useEffect(() => {
        ...
        try {
            ...
            const newChat = ai.chats.create({
                ...
                history: [{
                    role: 'user',
                    parts: [{ text: `Here is my financial data. Please analyze it for my questions: ${financialDataString}` }]
                }, {
                    role: 'model',
